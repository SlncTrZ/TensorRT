...
@dataclass
class KernelSpec:
    """Fully declarative description of a CUDA kernel.

    Kernel signature convention (required): the ``__global__`` function
    receives arguments in this fixed order — input pointers, then extras in
    ...
    outputs: Sequence[OutputDecl]
    extras: Sequence[ExtraArg]
    geometry: Geometry
